...
### Git State
$(cd /Users/sethford/Documents/aim && git log --oneline -5 2>/dev/null || echo "No git info")

### Recent Changes
$(cd /Users/sethford/Documents/aim && git diff --stat HEAD~1 2>/dev/null | tail -5 || echo "No changes")
EOF
